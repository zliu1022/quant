...
class StockOp:
    def __init__(self, ts_code, chg_perc, interval, max_cost):
        # 连接到 MongoDB
    ...
    def process_day(self):
        ...
        for i, row in self.day_df.iterrows():
            ...
            if len(bonus) > 0:
                ...
                print('xd min {} first_buy_p {} next_buy_price {} {} sell_exp_p {}'.format(self.min_price, self.first_buy_price, self.next_buy_price, self.next_buy_qty, self.sell_exp_price))
            ...
            while row["low"] <= self.next_buy_price:
                ...
                self.next_buy_price = (self.first_buy_price + self.next_buy_price) / 2
                print('buy {} {} {}'.format(buy_count, self.next_buy_price, self.next_buy_qty))

    def get_stat(self):
        return self.df_stat

if __name__ == '__main__':
    stock_op = StockOp("002050.SZ", chg_perc=1.55, interval=0.03, max_cost=0)
